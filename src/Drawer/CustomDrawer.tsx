      ...
      <View style={styles.menuContainer}>
        <View
          ...
          <>
            <View
              ...
              <Icons name="home" size={25} color="#fbae41" />
              <DrawerItem
                label="Screen1"
        ...
        <View
          ...
          <View
            ...
            <Icons name="medical" size={25} color="#609806" />
          </View>
...
function Feed({ navigation }: { navigation: { navigate: React.FC } }) {
  return (
...
function Article({ navigation }: { navigation: { navigate: React.FC } }) {
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
